          ...
          <div class="list">
            <div class="list-header">
              ...
              <div>
                ...
                <button type="button" class="btn btn-link" onclick="onQueryAnswerMessage('${item.id}')">统计</button>
              </div>
            </div>
...
const onQueryAnswerMessage = (id) =>{
  $util.setPageParam('projectId', id)
  location.href = "/pages/seeAnswerMessage/index.html"
}
